...
public abstract class ConfigurationOptions {
	...
	public static Option brailleUtilsCore() {
		return composite(
				...
				MavenRepo.CENTRAL.get("org.daisy.braille", "braille-utils.api", "4.3.0"),
				MavenRepo.CENTRAL.get("org.daisy.braille", "braille-utils.pef-tools", "3.1.0")
				);
	}
	
	public static Option brailleUtilsCatalog() {
		return MavenRepo.CENTRAL.get("org.daisy.braille", "braille-utils.impl", "4.1.0");
	}

	static Option dotifyApi() {
		return MavenRepo.CENTRAL.get("org.daisy.dotify", "dotify.api", "4.2.0");
	}
	...
	public static Option dotifyFormatter() {
		return composite( 
				...
				wstx(),
				saxon(),
				MavenRepo.SONATYPE_STAGING.get("org.daisy.dotify", "dotify.formatter.impl", "4.2.0")
			);
	}
	...
	public static Option dotifyTasks() {
		return composite(
				...
				jing(),
				saxon(),
				MavenRepo.SONATYPE_STAGING.get("org.daisy.dotify", "dotify.task.impl", "4.3.0")
			);
	}
